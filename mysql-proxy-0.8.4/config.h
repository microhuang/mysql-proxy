...
/* having event_base_free() */
#define HAVE_EVENT_BASE_FREE /**/

/* event_base_new() */
#define HAVE_EVENT_BASE_NEW /**/
...
/* Define to 1 if you have the `get_hrtime' function. */
/* #undef HAVE_GET_HRTIME */
...
#define PACKAGE_BUGREPORT "mysql-proxy-discuss@lists.launchpad.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "mysql-proxy"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "mysql-proxy 0.8.4"
...
/* lpackage-version-id */
#define PACKAGE_VERSION_ID (0 << 16 | 8 << 8 | 4)
